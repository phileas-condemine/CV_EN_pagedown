...
- Handling Big Data with **Python**+**PySpark** but also **R-data.table** when it's enough.

- Deep-learning with **Python** + **Pytorch & Keras** to model health sequences with NLP-like approach.

- Dashboard & interactive tailored tools with **R-Shiny**, leaflet, plotly, DT, rhandsontable...
...
### Currently looking a new DatAdventure :
...
3 years at French Ministry of Health : Modelling **Health Sequences**, handling **Big Data** from the Public Health Insurance (covers 100% of 67M french citizens). Also tailoring tools to gather & visualize data for decision making during CoViD-19 crisis.
