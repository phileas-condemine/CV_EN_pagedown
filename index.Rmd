...
- Multiple **NLP** projects **in Production** Tackling Labelling, **Annotation**, **Monitoring**, **MultiLabel Topic Classification**, **Sentiment Analysis** and Anonymization using fine-tuned RoBERTa-like **Transformers with HuggingFace** with **Azure + Databricks**.
